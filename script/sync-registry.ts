...
const PACKAGES = [
  "@nexus-code/cli",
  "@nexus-code/nexus-darwin-arm64",
  "@nexus-code/nexus-darwin-x64",
  "@nexus-code/nexus-darwin-x64-baseline",
  "@nexus-code/nexus-linux-arm64",
  "@nexus-code/nexus-linux-arm64-musl",
  "@nexus-code/nexus-linux-x64",
  "@nexus-code/nexus-linux-x64-baseline",
  "@nexus-code/nexus-linux-x64-musl",
  "@nexus-code/nexus-linux-x64-baseline-musl",
  "@nexus-code/nexus-windows-arm64",
  "@nexus-code/nexus-windows-x64",
  "@nexus-code/nexus-windows-x64-baseline",
]
...
async function syncNpmmirror(packageName: string) {
  ...
  const res = await fetch(url, {
    ...
    body: JSON.stringify({ skipDependencies: true, tips: "NexusCode release sync" }),
  })
  if (!res.ok) {
...
console.log("═══ NexusCode Registry Sync ═══")
