...
function realConfig() {
  const home = path.join(os.homedir(), ".config", "nexus", "nexus.json")
      ...
      provideTmpdirInstance(
        (dir) =>
          Effect.gen(function* () {
            ...
            // Two saved workflows on disk, resolved by name from .nexus/workflows.
            const wfDir = path.join(dir, ".nexus", "workflows")
