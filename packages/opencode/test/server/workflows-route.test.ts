...
// process-global `:memory:` DB (test/preload sets NEXUSCODE_DB=:memory:, and the
...
// `x-nexus-directory` header makes InstanceMiddleware re-enter the SAME cached
