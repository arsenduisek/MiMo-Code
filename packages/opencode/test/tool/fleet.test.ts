...
describe("assembleFleet", () => {
  test("correlates liveness, turn telemetry, and worktree mapping into grouped rows", () => {
    ...
    const worktrees: WorktreeEntry[] = [
      { directory: "/wt/a", branch: "nexus/port-parser", ahead: 3 },
      { directory: "/wt/b", branch: "nexus/billing", ahead: 0 },
    ]
    ...
    expect(a.branch).toBe("nexus/port-parser")
...
describe("renderFleetTable", () => {
  ...
  test("renders grouped headings, worktree cell, and summary line", () => {
    ...
    const worktrees: WorktreeEntry[] = [{ directory: "/wt/a", branch: "nexus/port-parser", ahead: 3 }]
    ...
    expect(out).toContain("nexus/port-parser (+3) @ /wt/a")
