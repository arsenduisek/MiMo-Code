...
const experimental = Flag.NEXUSCODE_EXPERIMENTAL_WORKSPACES

Flag.NEXUSCODE_EXPERIMENTAL_WORKSPACES = true
...
afterAll(() => {
  ...
  Flag.NEXUSCODE_EXPERIMENTAL_WORKSPACES = experimental
})
