...
function nexusConfig(baseURL: string, maxContext = 40_000, checkpoint?: { thresholds: string[]; reserved: number }) {
        ...
        await using tmp = await tmpdir({
          ...
          init: (dir) =>
            Bun.write(
              ...
              nexusConfig(llm.origin, 50_000, { thresholds: ["24K"], reserved: 100 }),
            ),
        })
