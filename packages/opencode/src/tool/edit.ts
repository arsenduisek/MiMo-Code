...
export function replace(content: string, oldString: string, newString: string, replaceAll = false): string {
  ...
  // NEXUSCODE_ENABLE_FUZZY_EDIT=true to opt into the legacy fuzzy fallback chain.
  if (!Flag.NEXUSCODE_ENABLE_FUZZY_EDIT) {
  ...
  // Fuzzy fallback chain (opt-in via NEXUSCODE_ENABLE_FUZZY_EDIT)
  let notFound = true
