...
const skipAllForcedAskTimeoutMs = () => Number(process.env.NEXUSCODE_SKIP_ALL_FORCED_ASK_TIMEOUT_MS) || 60 * 1000
...
// (e.g. NEXUSCODE_AUTO_APPROVE_DELETE for bash_delete) is the only bypass.
