...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const init = Effect.fn("Command.state")(function* (ctx: InstanceContext) {
      ...
      commands[Default.DREAM] = {
        ...
        get template() {
          return [
            ...
            "$ARGUMENTS",
            "",
            "Use the memory files as the working index and the raw nexus trajectory database as the source of truth.",
      ...
      commands[Default.DISTILL] = {
        ...
        get template() {
          return [
            ...
            "Use the raw nexus trajectory database as the source of truth and memory files to spot cross-session patterns.",
      ...
      if (Flag.NEXUSCODE_EXPERIMENTAL_WORKFLOW_TOOL) {
