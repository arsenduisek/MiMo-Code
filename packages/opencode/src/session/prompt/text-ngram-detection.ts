...
export function createTextNgramMonitor() {
  return new TextNgramMonitor(
    Flag.NEXUSCODE_TEXT_NGRAM_N,
    Flag.NEXUSCODE_TEXT_REPEAT_THRESHOLD,
    Flag.NEXUSCODE_TEXT_WINDOW_TOKENS,
  )
}
...
REPETITION DETECTED: Your recent output contains repeated phrases (sliding n-gram match within your last ${Flag.NEXUSCODE_TEXT_WINDOW_TOKENS} tokens).
