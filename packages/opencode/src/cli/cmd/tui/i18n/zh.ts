...
export const dict = {
  ...
  "tui.tips.free_api_sunset":
    "免费 API 服务已终止。请使用 {highlight}/login{/highlight} 登录，欢迎订阅Nexus Token Plan或配置第三方 API 后使用 Nexus Code。",
  ...
  "tui.tips.config_files":
    "创建 {highlight}nexus.json{/highlight} 用于服务端配置，{highlight}tui.json{/highlight} 用于 TUI 配置",
  "tui.tips.global_config": "把 TUI 配置放在 {highlight}~/.config/nexus/tui.json{/highlight} 作为全局配置",
  ...
  "tui.tips.custom_command":
    "在 {highlight}.nexus/command/{/highlight} 添加 {highlight}.md{/highlight} 文件以定义可复用自定义提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.nexus/agent/{/highlight} 添加 {highlight}.md{/highlight} 文件来创建专用 AI 角色",
  ...
  "tui.tips.custom_tool":
    "在 {highlight}.nexus/tools/{/highlight} 创建 {highlight}.ts{/highlight} 文件定义新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定义可以调用 Python、Go 等脚本",
  "tui.tips.plugins":
    "在 {highlight}.nexus/plugin/{/highlight} 添加 {highlight}.ts{/highlight} 文件挂接事件钩子",
  ...
  "tui.tips.theme_files": "在 {highlight}.nexus/themes/{/highlight} 目录下创建 JSON 主题文件",
  ...
  "tui.skill.nexus.description": "NexusCode 功能、配置与命令的自文档参考",
  ...
  "tui.skill.drive-nexus.description": "以编程方式驱动另一个 NexusCode 进程——无头 JSON 事件或通过 tmux 交互",
  ...
  "tui.skill.nexus.slash": "NexusCode文档",
  ...
  "tui.skill.drive-nexus.slash": "驱动NexusCode",
  ...
  "tui.context_limit.scalar_config": "compaction.max_context 当前是对所有模型生效的单值，请在 nexus.json 中改为按模型配置",
  "tui.context_limit.shadowed": "已保存，但仍有其他配置将其固定为 {{value}}，请检查项目的 nexus.json",
  ...
  "tui.dialog.free_api_sunset.message":
    "请使用 /login 登录，欢迎订阅Nexus Token Plan或配置第三方 API 后使用 Nexus Code。",
  ...
  "tui.model.nexus_auto.name": "Nexus Auto（Nexus-V2.5 限免至 7 月 26 日 18:00 · UTC+8）",
  "tui.model.nexus_auto.sunset_name": "Nexus Auto（Nexus-V2.5）",
  ...
  "tui.dialog.try_best.handoff.description": "让 Nexus 将未完成的工作委派给此 harness",
  ...
  "tui.voice.error.no_auth": "请先用 /connect 连接 Nexus 账号，或配置 voice.asr_model 指定其他 provider",
  ...
  "tui.dialog.login.gemini": "小米",
  "tui.dialog.login.gemini.desc": "（推荐）",
  ...
  "skip_permissions.body":
    "你使用 --dangerously-skip-permissions 启动。Nexus Code 将在不征求同意的情况下读取、修改、执行文件并运行 Shell 命令。只有你在配置中明确拒绝（deny）的规则仍然生效。由此产生的一切后果由你自行承担。",
