...
export const dict = {
  ...
  "tui.tips.free_api_sunset":
    "El servicio de API gratuita ha finalizado. Ejecuta {highlight}/login{/highlight} para iniciar sesión. Suscríbete a Nexus Token Plan o configura una API de terceros para usar Nexus Code.",
  ...
  "tui.tips.config_files":
    "Crea {highlight}nexus.json{/highlight} para la configuración del servidor y {highlight}tui.json{/highlight} para la TUI",
  "tui.tips.global_config":
    "Coloca la configuración de TUI en {highlight}~/.config/nexus/tui.json{/highlight} como configuración global",
  "tui.tips.schema":
  ...
  "tui.tips.custom_command":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.nexus/command/{/highlight} para definir indicaciones personalizadas reutilizables",
  ...
  "tui.tips.custom_agent":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.nexus/agent/{/highlight} para personajes de IA especializados",
  ...
  "tui.tips.custom_tool":
    "Crea archivos {highlight}.ts{/highlight} en {highlight}.nexus/tools/{/highlight} para definir nuevas herramientas LLM",
  "tui.tips.tool_scripts":
    "Las definiciones de herramientas pueden invocar scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Añade archivos {highlight}.ts{/highlight} en {highlight}.nexus/plugin/{/highlight} para enganchar eventos",
  ...
  "tui.tips.theme_files":
    "Crea archivos JSON de tema en el directorio {highlight}.nexus/themes/{/highlight}",
  ...
  "tui.skill.nexus.description": "Autodocumentación de funciones, configuración y comandos de NexusCode",
  ...
  "tui.skill.drive-nexus.description": "Controla programáticamente otro proceso NexusCode — eventos JSON headless o TUI interactiva vía tmux",
  ...
  "tui.dialog.free_api_sunset.message":
    "Ejecuta /login para iniciar sesión. Suscríbete a Nexus Token Plan o configura una API de terceros para usar Nexus Code.",
  ...
  "tui.model.nexus_auto.name": "Nexus Auto (Nexus-V2.5 gratis hasta el 26 de julio, 18:00 · UTC+8)",
  ...
  "tui.dialog.try_best.handoff.description": "Pedir a Nexus que delegue el trabajo pendiente en este entorno",
  ...
  "tui.voice.error.no_auth": "Usa /connect para conectar tu cuenta Nexus, o configura voice.asr_model para otro proveedor",
