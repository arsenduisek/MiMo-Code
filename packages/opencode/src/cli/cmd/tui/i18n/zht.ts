...
export const dict = {
  ...
  "tui.tips.free_api_sunset":
    "免費 API 服務已終止。請使用 {highlight}/login{/highlight} 登入，歡迎訂閱 Nexus Token Plan 或設定第三方 API 後使用 Nexus Code。",
  ...
  "tui.tips.config_files":
    "建立 {highlight}nexus.json{/highlight} 用於伺服器端設定，{highlight}tui.json{/highlight} 用於 TUI 設定",
  "tui.tips.global_config": "把 TUI 設定放在 {highlight}~/.config/nexus/tui.json{/highlight} 作為全域設定",
  ...
  "tui.tips.custom_command":
    "在 {highlight}.nexus/command/{/highlight} 加入 {highlight}.md{/highlight} 檔案以定義可重用自訂提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.nexus/agent/{/highlight} 加入 {highlight}.md{/highlight} 檔案來建立專用 AI 角色",
  ...
  "tui.tips.custom_tool":
    "在 {highlight}.nexus/tools/{/highlight} 建立 {highlight}.ts{/highlight} 檔案定義新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定義可呼叫 Python、Go 等指令稿",
  "tui.tips.plugins":
    "在 {highlight}.nexus/plugin/{/highlight} 加入 {highlight}.ts{/highlight} 檔案掛載事件勾點",
  ...
  "tui.tips.theme_files": "在 {highlight}.nexus/themes/{/highlight} 目錄下建立 JSON 主題檔案",
  ...
  "tui.skill.nexus.description": "NexusCode 功能、設定與命令的自文件參考",
  ...
  "tui.skill.drive-nexus.description": "以程式化方式驅動另一個 NexusCode 程序——無頭 JSON 事件或透過 tmux 互動",
  ...
  "tui.skill.nexus.slash": "NexusCode文件",
  ...
  "tui.skill.drive-nexus.slash": "驅動NexusCode",
  ...
  "tui.context_limit.scalar_config": "compaction.max_context 目前是對所有模型生效的單值，請在 nexus.json 中改為依模型設定",
  "tui.context_limit.shadowed": "已儲存，但仍有其他設定將其固定為 {{value}}，請檢查專案的 nexus.json",
  ...
  "tui.dialog.free_api_sunset.message":
    "請使用 /login 登入，歡迎訂閱 Nexus Token Plan 或設定第三方 API 後使用 Nexus Code。",
  ...
  "tui.dialog.try_best.handoff.description": "讓 Nexus 將未完成的工作委派給此 harness",
  ...
  "tui.voice.error.no_auth": "請先用 /connect 連接 Nexus 帳號，或配置 voice.asr_model 指定其他 provider",
