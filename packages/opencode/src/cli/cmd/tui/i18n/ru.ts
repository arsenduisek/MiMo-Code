...
export const dict = {
  ...
  "tui.tips.free_api_sunset":
    "Сервис бесплатного API завершён. Выполните {highlight}/login{/highlight}, чтобы войти. Оформите подписку на Nexus Token Plan или настройте сторонний API для использования Nexus Code.",
  ...
  "tui.tips.config_files":
    "Создайте {highlight}nexus.json{/highlight} для серверных настроек и {highlight}tui.json{/highlight} для настроек TUI",
  "tui.tips.global_config":
    "Поместите настройки TUI в {highlight}~/.config/nexus/tui.json{/highlight} как глобальные",
  "tui.tips.schema":
  ...
  "tui.tips.custom_command":
    "Добавляйте файлы {highlight}.md{/highlight} в {highlight}.nexus/command/{/highlight} для повторно используемых пользовательских команд",
  ...
  "tui.tips.custom_agent":
    "Добавляйте файлы {highlight}.md{/highlight} в {highlight}.nexus/agent/{/highlight} для специализированных AI-персон",
  ...
  "tui.tips.custom_tool":
    "Создавайте файлы {highlight}.ts{/highlight} в {highlight}.nexus/tools/{/highlight}, чтобы определить новые LLM-инструменты",
  "tui.tips.tool_scripts":
    "Определения инструментов могут вызывать скрипты на Python, Go и других языках",
  "tui.tips.plugins":
    "Добавляйте файлы {highlight}.ts{/highlight} в {highlight}.nexus/plugin/{/highlight} для подключения хуков событий",
  ...
  "tui.tips.theme_files":
    "Создавайте JSON-файлы тем в каталоге {highlight}.nexus/themes/{/highlight}",
  ...
  "tui.skill.nexus.description": "Самодокументация функций, конфигурации и команд NexusCode",
  ...
  "tui.skill.drive-nexus.description": "Программное управление другим процессом NexusCode — headless JSON-события или интерактивный TUI через tmux",
  ...
  "tui.dialog.free_api_sunset.message":
    "Выполните /login, чтобы войти. Оформите подписку на Nexus Token Plan или настройте сторонний API для использования Nexus Code.",
  ...
  "tui.model.nexus_auto.name": "Gemini (free tier)",
  "tui.model.nexus_auto.sunset_name": "Gemini",
  ...
  "tui.dialog.token_plan.link": "Nexus Token Plan",
  ...
  "tui.dialog.try_best.handoff.description": "Попросить Nexus поручить незавершённую работу этому исполнителю",
  ...
  "tui.voice.error.no_auth": "Используйте /connect для подключения к Nexus или настройте voice.asr_model для другого провайдера",
  ...
  "tui.dialog.login.nexus_free": "Gemini (free tier)",
  "tui.dialog.login.nexus_free.desc": "Анонимный бесплатный канал — вход не требуется",
  "tui.dialog.login.nexus_free.success": "Gemini подключен — модель по умолчанию: google/gemini-2.5-flash",
  "tui.dialog.login.nexus_free.unavailable": "Провайдер Gemini не загружен",
  ...
  "cli.providers.nexus_free.verifying": "Проверка канала Gemini...",
  "cli.providers.nexus_free.ready": "Канал Gemini готов",
  "cli.providers.nexus_free.failed": "Не удалось проверить Gemini",
  ...
  "skip_permissions.body":
    "Вы запустили с --dangerously-skip-permissions. Nexus Code будет читать, редактировать и выполнять файлы, а также запускать команды оболочки БЕЗ запроса подтверждения. Действуют только правила, которые вы явно запретили (deny) в конфигурации. Вы несёте полную ответственность за все его действия.",
