export const dict: Record<string, string> = {
  ...
  "tui.tips.free_api_sunset":
    "The free API service has ended. Run {highlight}/login{/highlight} to sign in. Subscribe to the Nexus Token Plan or configure a third-party API to use Nexus Code.",
  ...
  "tui.tips.config_files":
    "Create {highlight}nexus.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/nexus/tui.json{/highlight} for global config",
  ...
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.nexus/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.nexus/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.nexus/plugin/{/highlight} for event hooks",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.nexus/themes/{/highlight} directory",
  ...
  "tui.skill.nexus.description": "Self-documentation for NexusCode features, config, and commands",
  ...
  "tui.skill.drive-nexus.description": "Programmatically drive another NexusCode process — headless JSON events or interactive TUI via tmux",
  ...
  "tui.context_limit.scalar_config": "compaction.max_context is set to a single value for all models — edit it in nexus.json to switch to per-model limits",
  "tui.context_limit.shadowed": "Saved, but another config still forces {{value}} — check your project nexus.json",
  ...
  "tui.dialog.free_api_sunset.message":
    "Run /login to sign in. Subscribe to the Nexus Token Plan or configure a third-party API to use Nexus Code.",
  ...
  "tui.dialog.try_best.handoff.description": "Ask Nexus to delegate the unfinished work to this harness",
  ...
  "tui.voice.error.no_auth": "Use /connect to sign in to Nexus, or configure voice.asr_model for another provider",
  ...
  "tui.dialog.login.gemini": "Nexus",
  "tui.dialog.login.gemini.desc": "(Recommended)",
  ...
  "cli.providers.nexus_free.ready": "Gemini channel ready",
  ...
  "skip_permissions.body":
    "You started with --dangerously-skip-permissions. Nexus Code will read, edit, and execute files and run shell commands WITHOUT asking for approval. Only rules you have explicitly denied in config are still enforced. You are solely responsible for anything it does.",
