...
export const dict = {
  ...
  "tui.tips.free_api_sunset":
    "Le service API gratuit est terminé. Exécutez {highlight}/login{/highlight} pour vous connecter. Abonnez-vous au Nexus Token Plan ou configurez une API tierce pour utiliser Nexus Code.",
  ...
  "tui.tips.config_files":
    "Créez {highlight}nexus.json{/highlight} pour la configuration serveur et {highlight}tui.json{/highlight} pour le TUI",
  "tui.tips.global_config":
    "Placez les paramètres TUI dans {highlight}~/.config/nexus/tui.json{/highlight} comme configuration globale",
  ...
  "tui.tips.custom_command":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.nexus/command/{/highlight} pour définir des invites personnalisées réutilisables",
  ...
  "tui.tips.custom_agent":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.nexus/agent/{/highlight} pour des personas IA spécialisés",
  ...
  "tui.tips.custom_tool":
    "Créez des fichiers {highlight}.ts{/highlight} dans {highlight}.nexus/tools/{/highlight} pour définir de nouveaux outils LLM",
  "tui.tips.tool_scripts": "Les définitions d'outils peuvent invoquer des scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Ajoutez des fichiers {highlight}.ts{/highlight} dans {highlight}.nexus/plugin/{/highlight} pour des hooks d'événements",
  ...
  "tui.tips.theme_files":
    "Créez des fichiers de thème JSON dans le dossier {highlight}.nexus/themes/{/highlight}",
  ...
  "tui.skill.nexus.description": "Documentation intégrée des fonctionnalités, config et commandes NexusCode",
  ...
  "tui.skill.drive-nexus.description": "Piloter un autre processus NexusCode — événements JSON headless ou TUI interactive via tmux",
  ...
  "tui.dialog.free_api_sunset.message":
    "Exécutez /login pour vous connecter. Abonnez-vous au Nexus Token Plan ou configurez une API tierce pour utiliser Nexus Code.",
  ...
  "tui.model.nexus_auto.name": "Nexus Auto (Nexus-V2.5 gratuit jusqu’au 26 juillet à 18:00 · UTC+8)",
  ...
  "tui.dialog.try_best.handoff.description": "Demander à Nexus de déléguer le travail restant à ce harnais",
  ...
  "tui.voice.error.no_auth": "Utilisez /connect pour vous connecter à Nexus, ou configurez voice.asr_model pour un autre fournisseur",
