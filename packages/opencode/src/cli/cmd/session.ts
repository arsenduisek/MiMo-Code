...
function pagerCmd(): string[] {
  ...
  if (Flag.NEXUSCODE_GIT_BASH_PATH) {
    const less = path.join(Flag.NEXUSCODE_GIT_BASH_PATH, "..", "..", "usr", "bin", "less.exe")
...
export const SessionImportClaudeCommand = cmd({
  ...
  describe: "import Claude Code sessions (~/.claude/projects) into nexus",
  builder: (yargs: Argv) =>
    yargs.option("force", {
