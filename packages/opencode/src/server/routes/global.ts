...
const EVENT_QUEUE_CAPACITY = Number(process.env["NEXUSCODE_EVENT_QUEUE_CAPACITY"]) || 10_000
  ...
  new Hono()
    ...
    .post(
      ...
      describeRoute({
        ...
        description:
          "Import sessions from external AI tools (Claude Code, Codex, opencode) into nexus. Idempotent; pass force to re-sync. Per-source failures are not thrown as HTTP errors — they are collected into the corresponding stats.errors[] while other sources continue.",
