...
const releaseId = process.env.NEXUSCODE_RELEASE
if (!releaseId) throw new Error("NEXUSCODE_RELEASE is required")

const version = process.env.NEXUSCODE_VERSION
if (!version) throw new Error("NEXUSCODE_VERSION is required")
